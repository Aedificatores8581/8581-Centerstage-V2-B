...
public class redFar2plus1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d spike3 = new Pose2d(31,-36,Math.toRadians(90)),
                spike2 = new Pose2d(10,-36,Math.toRadians(10)),
                spike1 = new Pose2d(16,-49,Math.toRadians(0));

        Pose2d stack = new Pose2d(7.5,-57,Math.toRadians(-90));

        Pose2d frontOfSpikes = new Pose2d(11,-40, Math.toRadians(-90));
        Pose2d behindSpikes = new Pose2d(0,0,Math.toRadians(0));
        Pose2d nearSide = new Pose2d(11, 83, Math.toRadians(-90));

        Pose2d backdrop3 = new Pose2d(49,91,Math.toRadians(-90)),
                backdrop2 = new Pose2d(35,91,Math.toRadians(-90)),
                backdrop1 = new Pose2d(28,91,Math.toRadians(-90));
        Pose2d cornerPark = new Pose2d(58, 100, Math.toRadians(-90));
        Pose2d farPark = new Pose2d(10, 90, Math.toRadians(-90));
        ...
        TrajectorySequence position1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(spike3.getX(), spike3.getY()-4, spike3.getHeading()))
        ...
        if (opModeIsActive()) {
            ...
            arm.claw.right.open();
            sleep(100);
            arm.runToPosition(armBackdropPos+300);
            sleep(250);
